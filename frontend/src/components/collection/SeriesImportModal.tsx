                        ...
                        >
                            ...
                            {result.notFoundNames.length > 0 && (
                                <div className="mt-2 text-sm text-muted-foreground">
                                    <p className="text-xs text-muted-foreground/70 mb-1">Characters not in collection:</p>
                                    {result.notFoundNames.slice(0, 5).map((name, i) => (
                                        <p key={i} className="text-warning">{name}</p>
                                    ))}
                                    {result.notFoundNames.length > 5 && (
                                        <p className="text-warning">...and {result.notFoundNames.length - 5} more</p>
                                    )}
                                </div>
                            )}
                        </div>
